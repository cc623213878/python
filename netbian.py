...
#html = getHtml("http://www.netbian.com/s/guidao/index.htm")  # 获取该网址网页详细信息，html就是网页的源代码
#getImg(html,1) #从网页源代码中分析并下载保存图片
for i in range(9,10):
    html = getHtml("http://www.netbian.com/s/guidao/index_" + str(i) + ".htm")  # 获取该网址网页详细信息，html就是网页的源代码
