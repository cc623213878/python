        ...
        for l in li:
            ...
            for imgurl in imglist:
                ...
                while(True):
                    tempcount=0
                    try:
                        data = opener.open(imgurl, timeout=0.8)
...
#html = getHtml("http://www.netbian.com/dongwu/index.htm")  # 获取该网址网页详细信息，html就是网页的源代码
#getImg(html,1) #从网页源代码中分析并下载保存图片
for i in range(22,55):
    html = getHtml("http://www.netbian.com/dongwu/index_" + str(i) + ".htm")  # 获取该网址网页详细信息，html就是网页的源代码
